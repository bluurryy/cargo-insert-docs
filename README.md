...
To extract the crate documentation, `cargo-insert-docs` invokes `cargo +nightly-2026-01-01 rustdoc`. This will automatically install the required nightly toolchain.
