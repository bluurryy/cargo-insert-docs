...
- Update default nightly toolchain to `nightly-2026-07-04` (changed rustdoc json to version 60)

## [1.8.1] - 2026-06-25

### Fixed

- Fix building of release assets
...
- Update default nightly toolchain to `nightly-2026-06-22`
- Update dependencies
...
- Update default nightly toolchain to `nightly-2026-04-14`
- Update dependencies
...
- Update default nightly toolchain to `nightly-2026-02-24`
- Produce link definitions in original order when using subsections
- Refactor markdown rewrite logic
...
<!-- next-url -->
[Unreleased]: https://github.com/bluurryy/cargo-insert-docs/compare/v1.8.1...HEAD
...
[1.7.0]: https://github.com/bluurryy/cargo-insert-docs/releases/tag/v1.7.0
[1.6.0]: https://github.com/bluurryy/cargo-insert-docs/releases/tag/v1.6.0
[1.5.0]: https://github.com/bluurryy/cargo-insert-docs/releases/tag/v1.5.0
[1.4.0]: https://github.com/bluurryy/cargo-insert-docs/releases/tag/v1.4.0
