...
#[cfg(feature = "log")]
use crate::markdown_rs::util::char::format_byte_opt;

use crate::markdown_rs::util::{constant::TAB_SIZE, edit_map::EditMap};
...
pub enum Container {
    /// [Block quote][crate::markdown_rs::construct::block_quote].
    BlockQuote,
    /// [List item][crate::markdown_rs::construct::list_item].
    ListItem,
    /// [GFM: Footnote definition][crate::markdown_rs::construct::gfm_footnote_definition].
...
pub enum LabelKind {
    ...
    /// ```
    ///
    /// Construct: [Label start (image)][crate::markdown_rs::construct::label_start_image].
    Image,
    /// Label (image) link.
    ///
    /// ```markdown
    ...
    /// ```
    ///
    /// Construct: [Label start (link)][crate::markdown_rs::construct::label_start_link].
    Link,
    ...
    /// ```
    ///
    /// Construct: [GFM: Label start (footnote)][crate::markdown_rs::construct::gfm_label_start_footnote].
    GfmFootnote,
    ...
    /// ```
    ///
    /// Construct: [Label end][crate::markdown_rs::construct::label_end].
...
pub struct TokenizeState<'a> {
    ...
    ///
    /// Used when tokenizing [text content][crate::markdown_rs::construct::text].
...
pub struct Tokenizer<'a> {
    ...
    ///
    /// Used when tokenizing [flow content][crate::markdown_rs::construct::flow].
    pub interrupt: bool,
    /// Whether containers cannot “pierce” into the current construct.
    ///
    /// Used when tokenizing [document content][crate::markdown_rs::construct::document].
    pub concrete: bool,
