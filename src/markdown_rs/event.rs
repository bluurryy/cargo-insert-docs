...
use crate::markdown_rs::unist;
use crate::markdown_rs::util::constant::TAB_SIZE;
...
pub enum Name {
    ...
    ///
    /// * **Context**:
    ///   [text content][crate::markdown_rs::construct::text]
    /// * **Content model**:
    ...
    ///
    /// * **Context**:
    ///   [flow content][crate::markdown_rs::construct::flow]
    /// * **Content model**:
    ///   void
    /// * **Construct**:
    ///   [`blank_line`][crate::markdown_rs::construct::blank_line]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///
    /// * **Context**:
    ///   [document content][crate::markdown_rs::construct::document]
    /// * **Content model**:
    ///   [`BlockQuotePrefix`][Name::BlockQuotePrefix],
    ///   [flow content][crate::markdown_rs::construct::flow]
    /// * **Construct**:
    ///   [`block_quote`][crate::markdown_rs::construct::block_quote]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   void
    /// * **Construct**:
    ///   [`document`][crate::markdown_rs::construct::document]
    ByteOrderMark,
    ...
    ///
    /// * **Context**:
    ///   [string content][crate::markdown_rs::construct::string] or
    ///   [text content][crate::markdown_rs::construct::text]
    /// * **Content model**:
    ///   [`CharacterEscapeMarker`][Name::CharacterEscapeMarker],
    ///   [`CharacterEscapeValue`][Name::CharacterEscapeValue]
    /// * **Construct**:
    ///   [`character_escape`][crate::markdown_rs::construct::character_escape]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`CodeFencedFence`][Name::CodeFencedFence]
    /// * **Content model**:
    ///   [string content][crate::markdown_rs::construct::string]
    /// * **Construct**:
    ///   [`raw_flow`][crate::markdown_rs::construct::raw_flow]
    ///
    /// ## Example
    ...
    ///   [flow content][crate::markdown_rs::construct::flow]
    /// * **Content model**:
    ///   [content][crate::markdown_rs::construct::content]
    /// * **Construct**:
    ///   [`content`][crate::markdown_rs::construct::content]
    ///
    /// ## Example
    ...
    ///   void
    /// * **Construct**:
    ///   [`data`][crate::markdown_rs::construct::partial_data]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`SpaceOrTab`][Name::SpaceOrTab]
    /// * **Construct**:
    ///   [`definition`][crate::markdown_rs::construct::definition]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    /// * **Construct**:
    ///   [`destination`][crate::markdown_rs::construct::partial_destination]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`SpaceOrTab`][Name::SpaceOrTab]
    /// * **Construct**:
    ///   [`label`][crate::markdown_rs::construct::partial_label]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    /// * **Construct**:
    ///   [`attention`][crate::markdown_rs::construct::attention]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   void.
    /// * **Construct**:
    ///   [`gfm_autolink_literal`][crate::markdown_rs::construct::gfm_autolink_literal]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    /// * **Construct**:
    ///   [`gfm_label_start_footnote`][crate::markdown_rs::construct::gfm_label_start_footnote]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [document content][crate::markdown_rs::construct::flow]
    /// * **Construct**:
    ///   [`gfm_footnote_definition`][crate::markdown_rs::construct::gfm_footnote_definition]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`LineEnding`][Name::LineEnding]
    /// * **Construct**:
    ///   [`gfm_table`][crate::markdown_rs::construct::gfm_table]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    /// * **Construct**:
    ///   [`gfm_task_list_item_check`][crate::markdown_rs::construct::gfm_task_list_item_check]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   void
    /// * **Construct**:
    ///   [`hard_break_escape`][crate::markdown_rs::construct::hard_break_escape]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`SpaceOrTab`][Name::SpaceOrTab]
    /// * **Construct**:
    ///   [`heading_setext`][crate::markdown_rs::construct::heading_setext]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`LabelMarker`][Name::LabelMarker]
    /// * **Construct**:
    ///   [`label_start_image`][crate::markdown_rs::construct::label_start_image]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`LabelMarker`][Name::LabelMarker]
    /// * **Construct**:
    ///   [`label_start_link`][crate::markdown_rs::construct::label_start_link]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`LineEnding`][Name::LineEnding]
    /// * **Construct**:
    ///   [`mdx_esm`][crate::markdown_rs::construct::mdx_esm]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   void
    /// * **Construct**:
    ///   [`partial_mdx_expression`][crate::markdown_rs::construct::partial_mdx_expression]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    /// * **Construct**:
    ///   [`mdx_expression_flow`][crate::markdown_rs::construct::mdx_expression_flow]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`MdxExpressionData`][Name::MdxExpressionData]
    /// * **Construct**:
    ///   [`mdx_expression_text`][crate::markdown_rs::construct::mdx_expression_text]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    /// * **Construct**:
    ///   [`mdx_jsx_flow`][crate::markdown_rs::construct::mdx_jsx_flow]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [`MdxJsxTagSelfClosingMarker`][Name::MdxJsxTagSelfClosingMarker]
    /// * **Construct**:
    ///   [`mdx_jsx_text`][crate::markdown_rs::construct::mdx_jsx_text]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   void
    /// * **Construct**:
    ///   [`partial_mdx_jsx`][crate::markdown_rs::construct::partial_mdx_jsx]
    ///
    /// ## Example
    ///
    /// ```markdown
    ...
    ///   [text content][crate::markdown_rs::construct::text]
    /// * **Construct**:
    ///   [`paragraph`][crate::markdown_rs::construct::paragraph]
    ///
    /// ## Example
    ///
    /// ```markdown
...
pub enum Content {
    ...
    Flow,
    /// Represents [content][crate::markdown_rs::construct::content].
    #[allow(clippy::enum_variant_names)]
    Content,
    /// Represents [string content][crate::markdown_rs::construct::string].
    String,
    /// Represents [text content][crate::markdown_rs::construct::text].
    Text,
}
