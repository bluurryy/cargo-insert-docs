...
impl CompileOptions {
    ...
    /// <https://github.github.com/gfm/>.
    pub fn gfm() -> Self {
        Self { gfm_tagfilter: true, ..Self::default() }
    }
}
...
pub struct ParseOptions {
    ...
    /// with [`to_mdast()`][crate::markdown_rs::to_mdast()].
    ///
...
impl ParseOptions {
    ...
    /// <https://github.github.com/gfm/>
    pub fn gfm() -> Self {
        Self { constructs: Constructs::gfm(), ..Self::default() }
    }
    ...
    /// > cares about braces.
    pub fn mdx() -> Self {
        Self { constructs: Constructs::mdx(), ..Self::default() }
    }
}
...
impl Options {
    ...
    /// <https://github.github.com/gfm/>
    pub fn gfm() -> Self {
        Self { parse: ParseOptions::gfm(), compile: CompileOptions::gfm() }
    }
}
...
mod tests {
    use super::*;
    use crate::markdown_rs::util::mdx::Signal;
    use alloc::format;
