...
//! (<small>see [construct][crate::markdown_rs::construct] for character groups</small>):
//!
//! ```bnf
...
//!
//! [string]: crate::markdown_rs::construct::string
...
//! [sanitize_uri]: crate::markdown_rs::util::sanitize_uri::sanitize
//! [normalize_identifier]: crate::markdown_rs::util::normalize_identifier::normalize_identifier
...
use crate::markdown_rs::construct::partial_space_or_tab_eol::space_or_tab_eol;
use crate::markdown_rs::event::{Event, Kind, Name};
...
use crate::markdown_rs::tokenizer::{Label, LabelKind, LabelStart, Tokenizer};
