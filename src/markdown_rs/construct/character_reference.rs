...
//! [character_escape]: crate::markdown_rs::construct::character_reference
//! [decode_numeric]: crate::markdown_rs::util::character_reference::decode_numeric
//! [character_references]: crate::markdown_rs::util::constant::CHARACTER_REFERENCES
