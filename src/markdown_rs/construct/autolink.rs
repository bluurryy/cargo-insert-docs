...
//! [autolink_scheme_size_max]: crate::markdown_rs::util::constant::AUTOLINK_SCHEME_SIZE_MAX
//! [autolink_domain_size_max]: crate::markdown_rs::util::constant::AUTOLINK_DOMAIN_SIZE_MAX
//! [sanitize_uri]: crate::markdown_rs::util::sanitize_uri
...
use crate::markdown_rs::util::constant::{AUTOLINK_DOMAIN_SIZE_MAX, AUTOLINK_SCHEME_SIZE_MAX};
