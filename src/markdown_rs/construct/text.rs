...
//! [attention][crate::markdown_rs::construct::attention] (emphasis, gfm strikethrough, strong),
//! [raw (text)][crate::markdown_rs::construct::raw_text] (code (text), math (text)), and actual text.
//!
...
//! * [Raw (text)][crate::markdown_rs::construct::raw_text] (code (text), math (text))
//! * [GFM: Label start (footnote)][crate::markdown_rs::construct::gfm_label_start_footnote]
//! * [GFM: Task list item check][crate::markdown_rs::construct::gfm_task_list_item_check]
//! * [Hard break (escape)][crate::markdown_rs::construct::hard_break_escape]
//! * [HTML (text)][crate::markdown_rs::construct::html_text]
//! * [Label start (image)][crate::markdown_rs::construct::label_start_image]
//! * [Label start (link)][crate::markdown_rs::construct::label_start_link]
//! * [Label end][crate::markdown_rs::construct::label_end]
//! * [MDX: expression (text)][crate::markdown_rs::construct::mdx_expression_text]
//! * [MDX: JSX (text)][crate::markdown_rs::construct::mdx_jsx_text]
//!
//! > 👉 **Note**: for performance reasons, hard break (trailing) is formed by
//! > [whitespace][crate::markdown_rs::construct::partial_whitespace].

use crate::markdown_rs::construct::gfm_autolink_literal::resolve as resolve_gfm_autolink_literal;
